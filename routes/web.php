...
//Company Payment
	...
	Route::get('/latestBalance/{balance}', [App\Http\Controllers\Company_paymentController::class, 'latestBalance'])->name('latest.balance');
...
//Party Payment
	...
	Route::get('/pdf_check', [PdfController::class, 'viewPdf'])->name('check.pdf');
